...
namespace SistemaGestionData
{
    ...
    {
        internal static List<Usuario> ObtenerUsuario(int idUsuario, string _connection)
        {
        ...
        internal static List<Usuario> ListarUsuarios(string _connection)
        {
        ...
        internal static void CrearUsuario(Usuario usuario, string _connection)
        {
        ...
        internal static void ModificarUsuario(Usuario usuario, string _connection)
        {
        ...
        internal static void EliminarUsuario(Usuario usuario, string _connection)
        {
